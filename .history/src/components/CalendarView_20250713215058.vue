  ...
  try {
    ...
    const newAttributes = periods
      .flatMap((period, i) => {
        ...
        const isPastStart = startDate < lastClickDate
        const isPastPrediction = predictedDate < lastClickDate
        const isPastOvulation = ovulationDate < lastClickDate
        const lastClickDate = new Date('2025-07-15')
