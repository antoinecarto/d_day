<template>
  <div class="min-h-screen bg-gradient-to-b from-pink-50 to-gray-100 py-8 px-4">
    <div class="max-w-screen-md mx-auto bg-white shadow-xl rounded-2xl p-6 space-y-8">
      ...
      <div class="flex items-center justify-between w-full flex-nowrap">
        <h1 class="text-4xl font-extrabold text-pink-600 tracking-tight whitespace-nowrap">
          D-Day
        </h1>
        <button
          @click="showHelp = true"
          class="w-8 h-8 bg-pink-100 hover:bg-pink-200 text-pink-600 rounded-full flex items-center justify-center text-lg font-bold transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:ring-offset-2 flex-shrink-0"
      ...
      <section v-if="showSettings" class="space-y-6">
        ...
        <div class="bg-pink-50 border-2 border-pink-400 rounded-xl shadow-md">
          <button
