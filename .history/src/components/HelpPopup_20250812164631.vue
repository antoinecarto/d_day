<template>
  <teleport to="body">
    <transition name="fade">
      <div
        v-if="show"
        class="bg-white fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50"
        @click.self="close"
      >
        <div
          class="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-xl relative"
        >
          <!-- En-tête du popup -->
          ...
          <div class="px-6 py-6 space-y-6">
            ...
            <section>
              ...
              <div class="space-y-3 text-gray-600">
                ...
                <div class="flex items-start gap-2">
                  <span class="text-pink-500 mt-1">•</span>
                  <span
                    ><strong>Passage du local au cloud :</strong> Vous pouvez mettre à jour la base
                    de données. Firebase ou pas. À vous de choisir.</span
                  >
                </div>
              </div>
            </section>
            ...
            <section class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
              ...
              <p class="text-yellow-700 text-sm leading-relaxed">
                Si vous rencontrez une anomalie, créez une issue sur GitHub :
                <a
