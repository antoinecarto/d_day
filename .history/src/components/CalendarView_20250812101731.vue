    ...
    <div class="max-w-screen-md mx-auto bg-white shadow-xl rounded-2xl p-6 space-y-8">
      ...
      <section v-if="showSettings" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-4">
          ...
          <div
            class="overflow-y-auto scrollable border border-gray-200 rounded-md divide-y divide-gray-100 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100"
