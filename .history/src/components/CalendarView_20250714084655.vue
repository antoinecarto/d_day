...
import { collection, addDoc, getDocs, query, orderBy, deleteDoc } from 'firebase/firestore' // AJOUT deleteDoc
...
// Ajout variables pour gestion clic long
...
// --- AJOUT Gestion clic long ---
const onDayMouseDown = ({ date }) => {
  longPressTimer = setTimeout(() => {
    confirmDeletion(date)
  }, 800) // 800ms pour clic long
}
